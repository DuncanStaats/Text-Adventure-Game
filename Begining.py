...
while True:
    ...
    print("Through your struggles with the other inmate you develop a bond, a bond to escape together and see the light of day.")
    print("You devise a plan to sneek out at night and gather supplie from the ship for your row home, what will you do:")
    print("1. Check out the captain quarters and the helm.\n2. Check out the crews sleeping quarters.\n3. Check out the cafeteria and armory.")
